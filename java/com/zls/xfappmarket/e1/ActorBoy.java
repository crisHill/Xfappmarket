...
public class ActorBoy extends Actor {
    ...
    */
    ...
    public static final int RAW_BOY_WIDTH = 151;
    public static final int RAW_BOY_HEIGHT = 291;
    ...
    public ActorBoy(ImageView ui, Context context){
        super.ui = ui;
    ...
    public void init(int halfStageWidth, int stageHeight) {
        ...
        Bitmap boyRes = BitmapFactory.decodeResource(context.getResources(), R.mipmap.boy);
        int width = boyRes.getWidth();//1583
        ratio = width * 1.0 / RAW_WIDTH;//1.5

        //由于已知的 男孩图像width=151，height=291是原始尺寸，跟加载到手机上的尺寸不一样，所以需要换算；
        super.uiWidth = ((int)(RAW_BOY_WIDTH * ratio));
        super.uiHeight = ((int)(RAW_BOY_HEIGHT * ratio));
        ...
        //ui.setBottom((int) (stageHeight * Const.BOY_INIT_MARGIN_RATIO_2_TOP));
    ...
    public void startNextPhase(Informer informer) {
        ...
        int destX = ((int)(Const.RATIO_BOY_X_TO[Var.curPhase] * super.halfStageWidth - uiWidth));
